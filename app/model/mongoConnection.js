module.exports = {
    ...
    mongocount: function (collection, jsonwhr, callback) {
        var db = app.get('mongodb');
        var collection = db.collection(collection);
        collection.find(jsonwhr).count(function (err, count) {
            callback(err, count);
        });
    },
    mongoupdateone: function (collection, findjson, updatejson, callback) {
        var db = app.get('mongodb');
        var collection = db.collection(collection);
